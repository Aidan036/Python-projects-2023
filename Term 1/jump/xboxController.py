...
class Controller():
    ...
    def get_buttons(self):
        ...
        lb_joyb = self.controller.get_button[4]
        rb_joyb = self.controller.get_button[5]


        buttons_dict = {"CONT_A": a, "CONT_X": x, "CONT_B": b, "CONT_Y": y, "LJOYB": lb_joyb, "RJOYB": rb_joyb, }
        return buttons_dict
    ...
    def get_axes(self):
        ...
        right_x = self.controller.get_axis(4)
        left_trig = self.controller.get_axis(5)
        right_trig = self.controller.get_axis(6)
