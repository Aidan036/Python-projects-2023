...
class Application(Frame):
    ...
    def initUI(self):
        ...
        self.cd_lbl = Label(self, text=time, fg="green", font=("helvetica", 58))
        self.cd_lbl.place(x=0, y=150)
        ...
        self.minutes_lbl.place(x=750, y=300)
    ...
    def update(self):
        ...
        hours = StringVar
        hours = self.time_until(self.date).hours
        self.hours_lbl.config(text=hours)

        minutes = StringVar
        minutes = self.time_until(*self.date).minutes
        self.minutes_lbl.config(text=minutes)

        seconds = StringVar
        seconds = self.time_until(self.date).seconds
